            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input class="form-control {{$errors->first('title') ? "is-invalid": ""}}" placeholder="Post Title" tabindex="1" type="text" name="title" id="title"/>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control {{$errors->first('slug') ? "is-invalid": ""}}" readonly placeholder="Slug" type="text" name="slug" id="slug"/>
                  <div class="invalid-feedback">
                    {{$errors->first('slug')}}
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <textarea  class="form-control summernote-simple" tabindex="2" name="excerpt" id="excerpt" class="form-control {{$errors->first('excerpt') ? "is-invalid" : "" }}"></textarea>
                  <div class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <textarea  class="form-control" name="body" tabindex="3" id="body" class="form-control {{$errors->first('body') ? "is-invalid" : "" }}"></textarea>
                  <div class="invalid-feedback">
                    {{$errors->first('excerpt')}}
                  </div>
                </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  {{-- <input type="text" class="form-control {{$errors->first('published_at') ? "is-invalid": ""}}" placeholder="Y-m-d H:i:s" name="published_at" id="published_at"> --}}
                  <input type="text" class="form-control datetimepicker {{$errors->first('published_at') ? "is-invalid": ""}}" placeholder="Y-m-d H:i:s" name="published_at" id="published_at">
                  <div class="invalid-feedback">
                    {{$errors->first('published_at')}} perlu diisi
                  </div>
                </div>
